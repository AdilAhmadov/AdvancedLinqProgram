    ...
    public static class SeedData
    {
        public static List<Employee> Employees()
        {
            List<Employee> list = new List<Employee>()
           {
               ...
               new Employee() { Id= 6 , DepartmentId=2, Firstname="Namiq", AnnualSalary=3000.3m, IsManager=true, Lastname="Humana"},
               new Employee() { Id= 7 , DepartmentId=2, Firstname="Bob", AnnualSalary=5000.3m, IsManager=false, Lastname="Jones"},
               new Employee() { Id= 8 , DepartmentId=3, Firstname="Robert", AnnualSalary=2000.3m, IsManager=false, Lastname="Jones"},
               new Employee() { Id= 9 , DepartmentId=1, Firstname="Jon", AnnualSalary=8000.3m, IsManager=true, Lastname="Jones"},
           };
            return list;
        }
